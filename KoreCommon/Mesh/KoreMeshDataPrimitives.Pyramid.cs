...
public static partial class KoreMeshDataPrimitives
{
        ...
        KoreColorRGB linecolor, KoreMeshMaterial material)
    {
        ...
        int idxBase1 = pyramidMesh.AddVertex(new KoreXYZVector(baseVertex1.X, baseVertex1.Y, baseVertex1.Z), null, vertexColor);
        int idxBase2 = pyramidMesh.AddVertex(new KoreXYZVector(baseVertex2.X, baseVertex2.Y, baseVertex2.Z), null, vertexColor);
        int idxBase3 = pyramidMesh.AddVertex(new KoreXYZVector(baseVertex3.X, baseVertex3.Y, baseVertex3.Z), null, vertexColor);
        int idxBase4 = pyramidMesh.AddVertex(new KoreXYZVector(baseVertex4.X, baseVertex4.Y, baseVertex4.Z), null, vertexColor);
