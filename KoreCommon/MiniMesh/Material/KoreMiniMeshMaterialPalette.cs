...
// KoreMiniMeshMaterialPalette: A static class containing predefined materials accessible by name.
...
public static class KoreMiniMeshMaterialPalette
{
    public static readonly string DefaultMaterialName = "DefaultMaterial"; // Default material name KoreMiniMeshMaterialPalette.DefaultMaterialName
    public static readonly KoreMiniMeshMaterial DefaultMaterial = new(DefaultMaterialName, KoreColorRGB.White, 0.0f, 0.8f); // KoreMiniMeshMaterialPalette.DefaultMaterial

    private static readonly List<KoreMiniMeshMaterial> MaterialsList =
    [
        // ----------------------------------------------------------------------------------------
        // MARK: Basic Colors
        // ----------------------------------------------------------------------------------------
    ...
    public static KoreMiniMeshMaterial GetMaterial(string name)
    {
        return Find(name);
    }
